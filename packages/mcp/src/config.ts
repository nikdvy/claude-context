...
export interface ContextMcpConfig {
    ...
    milvusToken?: string;
    milvusDb?: string; // Optional, defaults to "default"
}
...
export function createMcpConfig(): ContextMcpConfig {
    ...
    const config: ContextMcpConfig = {
        ...
        milvusDb: envManager.get('MILVUS_DB') // Optional, defaults to "default"
    };
...
export function logConfigurationSummary(config: ContextMcpConfig): void {
    ...
    console.log(`[MCP]   Milvus Database: ${config.milvusDb || 'default'}`);
